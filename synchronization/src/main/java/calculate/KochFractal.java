...
public class KochFractal {
	...
	private SideEdgesCalculator sideEdgesCalculator;

	public KochFractal(SideEdgesCalculator sideEdgesCalculator) {
		this.sideEdgesCalculator = sideEdgesCalculator;
	}
